...
train_dataset = dataset["train"].train_test_split(test_size=0.1, seed=300)[
    "train"
]
eval_dataset = dataset["train"].train_test_split(test_size=0.1, seed=300)[
    "test"
]
...
dev_evaluator = TripletEvaluator(
    anchors=test_dataset["anchor"][:100],
    positives=test_dataset["positive"][:100],
    negatives=test_dataset["negative"][:100],
...
model.push_to_hub(
    "parlbert-german-search-v3", revision="larger_dataset", create_pr=True
)
